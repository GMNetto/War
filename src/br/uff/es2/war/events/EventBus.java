 ...
 * ex:
 * EventBus bus = ...
 * bus.subscribe(String.class, new MyStringAction());
 * bus.subscribe(Object.class, new MyObjectAction());
 * //in other point of the code
 * bus.publish("something");
 * 
 * This will trigger both MyStringAction and MyObjectAction.
 * The value "something" will be argument of the actions.
 * 
