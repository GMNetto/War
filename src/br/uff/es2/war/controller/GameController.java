...
//		Persistence.createEntityManagerFactory("WarESIIPU"));
        ...
        for (j = 0; j < WarServer.PLAYER_PER_GAME; j++) {
            if (players[j] instanceof BasicBot) {
