...
/**
 * Declaration of a combat. During the combat phase the current player choose a
 * attacking territory, a defending territory and how many soldiers will attack.
 * The owner of the defending territory answer the combat by choosing how many
 * soldiers will defend.
 * 
 * The defending territory must be on the borders of the attacking territory.
 * The maximum number of soldiers attacking or defending is 3.
 * 
 * @see CombatPhase
 * @see Territory
