...
public class ObjetivoJpaController implements Serializable {
    ...
    public void create(Objetivo objetivo) {
        ...
        try {
            ...
            for (Historico historicoCollectionHistoricoToAttach : objetivo.getHistoricoCollection()) {
            ...
            for (Objderjogador objderjogadorCollectionObjderjogadorToAttach : objetivo.getObjderjogadorCollection()) {
            ...
            for (Objderjogador objderjogadorCollection1ObjderjogadorToAttach : objetivo.getObjderjogadorCollection1()) {
                objderjogadorCollection1ObjderjogadorToAttach = em.getReference(objderjogadorCollection1ObjderjogadorToAttach.getClass(), objderjogadorCollection1ObjderjogadorToAttach.getObjderjogadorPK());
                attachedObjderjogadorCollection1.add(objderjogadorCollection1ObjderjogadorToAttach);
            }
            objetivo.setObjderjogadorCollection1(attachedObjderjogadorCollection1);
            em.persist(objetivo);
            if (objterritorio != null) {
                Objetivo oldObjetivoOfObjterritorio = objterritorio.getObjetivo();
                if (oldObjetivoOfObjterritorio != null) {
                    oldObjetivoOfObjterritorio.setObjterritorio(null);
                    oldObjetivoOfObjterritorio = em.merge(oldObjetivoOfObjterritorio);
                }
            ...
            for (Jogam jogamCollectionJogam : objetivo.getJogamCollection()) {
                ...
                if (oldCodObjetivoOfJogamCollectionJogam != null) {
                    oldCodObjetivoOfJogamCollectionJogam.getJogamCollection().remove(jogamCollectionJogam);
                    oldCodObjetivoOfJogamCollectionJogam = em.merge(oldCodObjetivoOfJogamCollectionJogam);
                }
            }
            for (Historico historicoCollectionHistorico : objetivo.getHistoricoCollection()) {
                Objetivo oldCodObjetivoOfHistoricoCollectionHistorico = historicoCollectionHistorico.getCodObjetivo();
                ...
                if (oldCodObjetivoOfHistoricoCollectionHistorico != null) {
                    oldCodObjetivoOfHistoricoCollectionHistorico.getHistoricoCollection().remove(historicoCollectionHistorico);
                    oldCodObjetivoOfHistoricoCollectionHistorico = em.merge(oldCodObjetivoOfHistoricoCollectionHistorico);
                }
            }
            for (Objderjogador objderjogadorCollectionObjderjogador : objetivo.getObjderjogadorCollection()) {
                Objetivo oldObjetivoOfObjderjogadorCollectionObjderjogador = objderjogadorCollectionObjderjogador.getObjetivo();
                ...
                if (oldObjetivoOfObjderjogadorCollectionObjderjogador != null) {
                    oldObjetivoOfObjderjogadorCollectionObjderjogador.getObjderjogadorCollection().remove(objderjogadorCollectionObjderjogador);
                    oldObjetivoOfObjderjogadorCollectionObjderjogador = em.merge(oldObjetivoOfObjderjogadorCollectionObjderjogador);
                }
            }
            for (Objderjogador objderjogadorCollection1Objderjogador : objetivo.getObjderjogadorCollection1()) {
                Objetivo oldObjetivo1OfObjderjogadorCollection1Objderjogador = objderjogadorCollection1Objderjogador.getObjetivo1();
                objderjogadorCollection1Objderjogador.setObjetivo1(objetivo);
                objderjogadorCollection1Objderjogador = em.merge(objderjogadorCollection1Objderjogador);
                if (oldObjetivo1OfObjderjogadorCollection1Objderjogador != null) {
                    oldObjetivo1OfObjderjogadorCollection1Objderjogador.getObjderjogadorCollection1().remove(objderjogadorCollection1Objderjogador);
                    oldObjetivo1OfObjderjogadorCollection1Objderjogador = em.merge(oldObjetivo1OfObjderjogadorCollection1Objderjogador);
                }
            }
    ...
    public void edit(Objetivo objetivo) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            Collection<Historico> historicoCollectionNew = objetivo.getHistoricoCollection();
            Collection<Objderjogador> objderjogadorCollectionOld = persistentObjetivo.getObjderjogadorCollection();
            Collection<Objderjogador> objderjogadorCollectionNew = objetivo.getObjderjogadorCollection();
            Collection<Objderjogador> objderjogadorCollection1Old = persistentObjetivo.getObjderjogadorCollection1();
            Collection<Objderjogador> objderjogadorCollection1New = objetivo.getObjderjogadorCollection1();
            List<String> illegalOrphanMessages = null;
            if (objterritorioOld != null && !objterritorioOld.equals(objterritorioNew)) {
            ...
            for (Jogam jogamCollectionOldJogam : jogamCollectionOld) {
                if (!jogamCollectionNew.contains(jogamCollectionOldJogam)) {
                    ...
                    illegalOrphanMessages.add("You must retain Jogam " + jogamCollectionOldJogam + " since its codObjetivo field is not nullable.");
                }
            }
            for (Objderjogador objderjogadorCollectionOldObjderjogador : objderjogadorCollectionOld) {
                if (!objderjogadorCollectionNew.contains(objderjogadorCollectionOldObjderjogador)) {
                    ...
                    illegalOrphanMessages.add("You must retain Objderjogador " + objderjogadorCollectionOldObjderjogador + " since its objetivo field is not nullable.");
                }
            }
            for (Objderjogador objderjogadorCollection1OldObjderjogador : objderjogadorCollection1Old) {
                if (!objderjogadorCollection1New.contains(objderjogadorCollection1OldObjderjogador)) {
                    if (illegalOrphanMessages == null) {
                        illegalOrphanMessages = new ArrayList<String>();
                    }
                    illegalOrphanMessages.add("You must retain Objderjogador " + objderjogadorCollection1OldObjderjogador + " since its objetivo1 field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Objderjogador objderjogadorCollection1NewObjderjogadorToAttach : objderjogadorCollection1New) {
                objderjogadorCollection1NewObjderjogadorToAttach = em.getReference(objderjogadorCollection1NewObjderjogadorToAttach.getClass(), objderjogadorCollection1NewObjderjogadorToAttach.getObjderjogadorPK());
                attachedObjderjogadorCollection1New.add(objderjogadorCollection1NewObjderjogadorToAttach);
            }
            ...
            if (objterritorioNew != null && !objterritorioNew.equals(objterritorioOld)) {
                Objetivo oldObjetivoOfObjterritorio = objterritorioNew.getObjetivo();
                if (oldObjetivoOfObjterritorio != null) {
                    oldObjetivoOfObjterritorio.setObjterritorio(null);
                    oldObjetivoOfObjterritorio = em.merge(oldObjetivoOfObjterritorio);
                }
            ...
            for (Jogam jogamCollectionNewJogam : jogamCollectionNew) {
                if (!jogamCollectionOld.contains(jogamCollectionNewJogam)) {
                    Objetivo oldCodObjetivoOfJogamCollectionNewJogam = jogamCollectionNewJogam.getCodObjetivo();
                    jogamCollectionNewJogam.setCodObjetivo(objetivo);
                    jogamCollectionNewJogam = em.merge(jogamCollectionNewJogam);
                    if (oldCodObjetivoOfJogamCollectionNewJogam != null && !oldCodObjetivoOfJogamCollectionNewJogam.equals(objetivo)) {
                        oldCodObjetivoOfJogamCollectionNewJogam.getJogamCollection().remove(jogamCollectionNewJogam);
                        oldCodObjetivoOfJogamCollectionNewJogam = em.merge(oldCodObjetivoOfJogamCollectionNewJogam);
                    }
                }
            }
            ...
            for (Historico historicoCollectionNewHistorico : historicoCollectionNew) {
                if (!historicoCollectionOld.contains(historicoCollectionNewHistorico)) {
                    Objetivo oldCodObjetivoOfHistoricoCollectionNewHistorico = historicoCollectionNewHistorico.getCodObjetivo();
                    ...
                    if (oldCodObjetivoOfHistoricoCollectionNewHistorico != null && !oldCodObjetivoOfHistoricoCollectionNewHistorico.equals(objetivo)) {
                        oldCodObjetivoOfHistoricoCollectionNewHistorico.getHistoricoCollection().remove(historicoCollectionNewHistorico);
                        oldCodObjetivoOfHistoricoCollectionNewHistorico = em.merge(oldCodObjetivoOfHistoricoCollectionNewHistorico);
                    }
                }
            }
            for (Objderjogador objderjogadorCollectionNewObjderjogador : objderjogadorCollectionNew) {
                if (!objderjogadorCollectionOld.contains(objderjogadorCollectionNewObjderjogador)) {
                    Objetivo oldObjetivoOfObjderjogadorCollectionNewObjderjogador = objderjogadorCollectionNewObjderjogador.getObjetivo();
                    objderjogadorCollectionNewObjderjogador.setObjetivo(objetivo);
                    objderjogadorCollectionNewObjderjogador = em.merge(objderjogadorCollectionNewObjderjogador);
                    if (oldObjetivoOfObjderjogadorCollectionNewObjderjogador != null && !oldObjetivoOfObjderjogadorCollectionNewObjderjogador.equals(objetivo)) {
                        oldObjetivoOfObjderjogadorCollectionNewObjderjogador.getObjderjogadorCollection().remove(objderjogadorCollectionNewObjderjogador);
                        oldObjetivoOfObjderjogadorCollectionNewObjderjogador = em.merge(oldObjetivoOfObjderjogadorCollectionNewObjderjogador);
                    }
                }
            }
            for (Objderjogador objderjogadorCollection1NewObjderjogador : objderjogadorCollection1New) {
                if (!objderjogadorCollection1Old.contains(objderjogadorCollection1NewObjderjogador)) {
                    Objetivo oldObjetivo1OfObjderjogadorCollection1NewObjderjogador = objderjogadorCollection1NewObjderjogador.getObjetivo1();
                    objderjogadorCollection1NewObjderjogador.setObjetivo1(objetivo);
                    objderjogadorCollection1NewObjderjogador = em.merge(objderjogadorCollection1NewObjderjogador);
                    if (oldObjetivo1OfObjderjogadorCollection1NewObjderjogador != null && !oldObjetivo1OfObjderjogadorCollection1NewObjderjogador.equals(objetivo)) {
                        oldObjetivo1OfObjderjogadorCollection1NewObjderjogador.getObjderjogadorCollection1().remove(objderjogadorCollection1NewObjderjogador);
                        oldObjetivo1OfObjderjogadorCollection1NewObjderjogador = em.merge(oldObjetivo1OfObjderjogadorCollection1NewObjderjogador);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<String> illegalOrphanMessages = null;
            Objterritorio objterritorioOrphanCheck = objetivo.getObjterritorio();
            ...
            for (Jogam jogamCollectionOrphanCheckJogam : jogamCollectionOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Objetivo (" + objetivo + ") cannot be destroyed since the Jogam " + jogamCollectionOrphanCheckJogam + " in its jogamCollection field has a non-nullable codObjetivo field.");
            }
            Collection<Objderjogador> objderjogadorCollectionOrphanCheck = objetivo.getObjderjogadorCollection();
            for (Objderjogador objderjogadorCollectionOrphanCheckObjderjogador : objderjogadorCollectionOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Objetivo (" + objetivo + ") cannot be destroyed since the Objderjogador " + objderjogadorCollectionOrphanCheckObjderjogador + " in its objderjogadorCollection field has a non-nullable objetivo field.");
            }
            Collection<Objderjogador> objderjogadorCollection1OrphanCheck = objetivo.getObjderjogadorCollection1();
            for (Objderjogador objderjogadorCollection1OrphanCheckObjderjogador : objderjogadorCollection1OrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Objetivo (" + objetivo + ") cannot be destroyed since the Objderjogador " + objderjogadorCollection1OrphanCheckObjderjogador + " in its objderjogadorCollection1 field has a non-nullable objetivo1 field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
