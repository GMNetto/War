...
public class OcupacaoJpaController implements Serializable {
    ...
    public void create(Ocupacao ocupacao) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (territorio != null) {
                territorio = em.getReference(territorio.getClass(), territorio.getCodTerritorio());
            ...
            if (findOcupacao(ocupacao.getOcupacaoPK()) != null) {
                throw new PreexistingEntityException("Ocupacao " + ocupacao + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(Ocupacao ocupacao) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Ocupacao persistentOcupacao = em.find(Ocupacao.class, ocupacao.getOcupacaoPK());
            ...
            if (territorioNew != null) {
                territorioNew = em.getReference(territorioNew.getClass(), territorioNew.getCodTerritorio());
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findOcupacao(id) == null) {
                    throw new NonexistentEntityException("The ocupacao with id " + id + " no longer exists.");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(OcupacaoPK id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The ocupacao with id " + id + " no longer exists.", enfe);
            }
            Jogam jogam = ocupacao.getJogam();
            if (jogam != null) {
    ...
    private List<Ocupacao> findOcupacaoEntities(boolean all, int maxResults, int firstResult) {
