...
public class CartaJpaController implements Serializable {
    ...
    public void create(Carta carta) {
        ...
        try {
            ...
            if (codTerritorio != null) {
                codTerritorio = em.getReference(codTerritorio.getClass(), codTerritorio.getCodTerritorio());
                carta.setCodTerritorio(codTerritorio);
            }
            Collection<Jogadorcarta> attachedJogadorcartaCollection = new ArrayList<Jogadorcarta>();
            for (Jogadorcarta jogadorcartaCollectionJogadorcartaToAttach : carta.getJogadorcartaCollection()) {
            ...
            for (Jogadorcarta jogadorcartaCollectionJogadorcarta : carta.getJogadorcartaCollection()) {
                Carta oldCartaOfJogadorcartaCollectionJogadorcarta = jogadorcartaCollectionJogadorcarta.getCarta();
                ...
                if (oldCartaOfJogadorcartaCollectionJogadorcarta != null) {
                    oldCartaOfJogadorcartaCollectionJogadorcarta.getJogadorcartaCollection().remove(jogadorcartaCollectionJogadorcarta);
                    oldCartaOfJogadorcartaCollectionJogadorcarta = em.merge(oldCartaOfJogadorcartaCollectionJogadorcarta);
                }
            }
    ...
    public void edit(Carta carta) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            ...
            Collection<Jogadorcarta> jogadorcartaCollectionOld = persistentCarta.getJogadorcartaCollection();
            Collection<Jogadorcarta> jogadorcartaCollectionNew = carta.getJogadorcartaCollection();
            ...
            for (Jogadorcarta jogadorcartaCollectionOldJogadorcarta : jogadorcartaCollectionOld) {
                if (!jogadorcartaCollectionNew.contains(jogadorcartaCollectionOldJogadorcarta)) {
                    ...
                    illegalOrphanMessages.add("You must retain Jogadorcarta " + jogadorcartaCollectionOldJogadorcarta + " since its carta field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            if (codTerritorioNew != null) {
                codTerritorioNew = em.getReference(codTerritorioNew.getClass(), codTerritorioNew.getCodTerritorio());
            ...
            if (codTerritorioOld != null && !codTerritorioOld.equals(codTerritorioNew)) {
                codTerritorioOld.setCarta(null);
                codTerritorioOld = em.merge(codTerritorioOld);
            }
            if (codTerritorioNew != null && !codTerritorioNew.equals(codTerritorioOld)) {
            ...
            for (Jogadorcarta jogadorcartaCollectionNewJogadorcarta : jogadorcartaCollectionNew) {
                if (!jogadorcartaCollectionOld.contains(jogadorcartaCollectionNewJogadorcarta)) {
                    Carta oldCartaOfJogadorcartaCollectionNewJogadorcarta = jogadorcartaCollectionNewJogadorcarta.getCarta();
                    ...
                    if (oldCartaOfJogadorcartaCollectionNewJogadorcarta != null && !oldCartaOfJogadorcartaCollectionNewJogadorcarta.equals(carta)) {
                        oldCartaOfJogadorcartaCollectionNewJogadorcarta.getJogadorcartaCollection().remove(jogadorcartaCollectionNewJogadorcarta);
                        oldCartaOfJogadorcartaCollectionNewJogadorcarta = em.merge(oldCartaOfJogadorcartaCollectionNewJogadorcarta);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<String> illegalOrphanMessages = null;
            Collection<Jogadorcarta> jogadorcartaCollectionOrphanCheck = carta.getJogadorcartaCollection();
            for (Jogadorcarta jogadorcartaCollectionOrphanCheckJogadorcarta : jogadorcartaCollectionOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Carta (" + carta + ") cannot be destroyed since the Jogadorcarta " + jogadorcartaCollectionOrphanCheckJogadorcarta + " in its jogadorcartaCollection field has a non-nullable carta field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
