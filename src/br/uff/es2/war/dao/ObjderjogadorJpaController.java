...
public class ObjderjogadorJpaController implements Serializable {
    ...
    public void create(Objderjogador objderjogador) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (objetivo1 != null) {
                objetivo1 = em.getReference(objetivo1.getClass(), objetivo1.getCodObjetivo());
            ...
            if (findObjderjogador(objderjogador.getObjderjogadorPK()) != null) {
                throw new PreexistingEntityException("Objderjogador " + objderjogador + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(Objderjogador objderjogador) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Objderjogador persistentObjderjogador = em.find(Objderjogador.class, objderjogador.getObjderjogadorPK());
            ...
            if (objetivo1New != null) {
                objetivo1New = em.getReference(objetivo1New.getClass(), objetivo1New.getCodObjetivo());
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findObjderjogador(id) == null) {
                    throw new NonexistentEntityException("The objderjogador with id " + id + " no longer exists.");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(ObjderjogadorPK id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The objderjogador with id " + id + " no longer exists.", enfe);
            }
            Cor cor = objderjogador.getCor();
            if (cor != null) {
    ...
    public List<Objderjogador> findObjderjogadorEntities(int maxResults, int firstResult) {
        return findObjderjogadorEntities(false, maxResults, firstResult);
    }

    private List<Objderjogador> findObjderjogadorEntities(boolean all, int maxResults, int firstResult) {
