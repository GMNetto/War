...
public class JogamJpaController implements Serializable {
    ...
    public void create(Jogam jogam) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (jogador != null) {
                jogador = em.getReference(jogador.getClass(), jogador.getCodJogador());
            ...
            for (Ocupacao ocupacaoCollectionOcupacaoToAttach : jogam.getOcupacaoCollection()) {
                ocupacaoCollectionOcupacaoToAttach = em.getReference(ocupacaoCollectionOcupacaoToAttach.getClass(), ocupacaoCollectionOcupacaoToAttach.getOcupacaoPK());
                attachedOcupacaoCollection.add(ocupacaoCollectionOcupacaoToAttach);
            }
            ...
            for (Jogadorcarta jogadorcartaCollectionJogadorcartaToAttach : jogam.getJogadorcartaCollection()) {
                jogadorcartaCollectionJogadorcartaToAttach = em.getReference(jogadorcartaCollectionJogadorcartaToAttach.getClass(), jogadorcartaCollectionJogadorcartaToAttach.getJogadorcartaPK());
                attachedJogadorcartaCollection.add(jogadorcartaCollectionJogadorcartaToAttach);
            }
            ...
            for (Ocupacao ocupacaoCollectionOcupacao : jogam.getOcupacaoCollection()) {
                Jogam oldJogamOfOcupacaoCollectionOcupacao = ocupacaoCollectionOcupacao.getJogam();
                ocupacaoCollectionOcupacao.setJogam(jogam);
                ocupacaoCollectionOcupacao = em.merge(ocupacaoCollectionOcupacao);
                if (oldJogamOfOcupacaoCollectionOcupacao != null) {
                    oldJogamOfOcupacaoCollectionOcupacao.getOcupacaoCollection().remove(ocupacaoCollectionOcupacao);
                    oldJogamOfOcupacaoCollectionOcupacao = em.merge(oldJogamOfOcupacaoCollectionOcupacao);
                }
            }
            for (Jogadorcarta jogadorcartaCollectionJogadorcarta : jogam.getJogadorcartaCollection()) {
                Jogam oldJogamOfJogadorcartaCollectionJogadorcarta = jogadorcartaCollectionJogadorcarta.getJogam();
                jogadorcartaCollectionJogadorcarta.setJogam(jogam);
                jogadorcartaCollectionJogadorcarta = em.merge(jogadorcartaCollectionJogadorcarta);
                if (oldJogamOfJogadorcartaCollectionJogadorcarta != null) {
                    oldJogamOfJogadorcartaCollectionJogadorcarta.getJogadorcartaCollection().remove(jogadorcartaCollectionJogadorcarta);
                    oldJogamOfJogadorcartaCollectionJogadorcarta = em.merge(oldJogamOfJogadorcartaCollectionJogadorcarta);
                }
            }
            em.getTransaction().commit();
        } catch (Exception ex) {
            if (findJogam(jogam.getJogamPK()) != null) {
                throw new PreexistingEntityException("Jogam " + jogam + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(Jogam jogam) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            Collection<Ocupacao> ocupacaoCollectionOld = persistentJogam.getOcupacaoCollection();
            Collection<Ocupacao> ocupacaoCollectionNew = jogam.getOcupacaoCollection();
            Collection<Jogadorcarta> jogadorcartaCollectionOld = persistentJogam.getJogadorcartaCollection();
            Collection<Jogadorcarta> jogadorcartaCollectionNew = jogam.getJogadorcartaCollection();
            List<String> illegalOrphanMessages = null;
            for (Ocupacao ocupacaoCollectionOldOcupacao : ocupacaoCollectionOld) {
                if (!ocupacaoCollectionNew.contains(ocupacaoCollectionOldOcupacao)) {
                    if (illegalOrphanMessages == null) {
                        illegalOrphanMessages = new ArrayList<String>();
                    }
                    illegalOrphanMessages.add("You must retain Ocupacao " + ocupacaoCollectionOldOcupacao + " since its jogam field is not nullable.");
                }
            }
            for (Jogadorcarta jogadorcartaCollectionOldJogadorcarta : jogadorcartaCollectionOld) {
                if (!jogadorcartaCollectionNew.contains(jogadorcartaCollectionOldJogadorcarta)) {
                    if (illegalOrphanMessages == null) {
                        illegalOrphanMessages = new ArrayList<String>();
                    }
                    illegalOrphanMessages.add("You must retain Jogadorcarta " + jogadorcartaCollectionOldJogadorcarta + " since its jogam field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            if (jogadorNew != null) {
                jogadorNew = em.getReference(jogadorNew.getClass(), jogadorNew.getCodJogador());
            ...
            for (Ocupacao ocupacaoCollectionNewOcupacaoToAttach : ocupacaoCollectionNew) {
                ocupacaoCollectionNewOcupacaoToAttach = em.getReference(ocupacaoCollectionNewOcupacaoToAttach.getClass(), ocupacaoCollectionNewOcupacaoToAttach.getOcupacaoPK());
                attachedOcupacaoCollectionNew.add(ocupacaoCollectionNewOcupacaoToAttach);
            }
            ...
            for (Jogadorcarta jogadorcartaCollectionNewJogadorcartaToAttach : jogadorcartaCollectionNew) {
                jogadorcartaCollectionNewJogadorcartaToAttach = em.getReference(jogadorcartaCollectionNewJogadorcartaToAttach.getClass(), jogadorcartaCollectionNewJogadorcartaToAttach.getJogadorcartaPK());
                attachedJogadorcartaCollectionNew.add(jogadorcartaCollectionNewJogadorcartaToAttach);
            }
            ...
            for (Ocupacao ocupacaoCollectionNewOcupacao : ocupacaoCollectionNew) {
                if (!ocupacaoCollectionOld.contains(ocupacaoCollectionNewOcupacao)) {
                    Jogam oldJogamOfOcupacaoCollectionNewOcupacao = ocupacaoCollectionNewOcupacao.getJogam();
                    ocupacaoCollectionNewOcupacao.setJogam(jogam);
                    ocupacaoCollectionNewOcupacao = em.merge(ocupacaoCollectionNewOcupacao);
                    if (oldJogamOfOcupacaoCollectionNewOcupacao != null && !oldJogamOfOcupacaoCollectionNewOcupacao.equals(jogam)) {
                        oldJogamOfOcupacaoCollectionNewOcupacao.getOcupacaoCollection().remove(ocupacaoCollectionNewOcupacao);
                        oldJogamOfOcupacaoCollectionNewOcupacao = em.merge(oldJogamOfOcupacaoCollectionNewOcupacao);
                    }
                }
            }
            for (Jogadorcarta jogadorcartaCollectionNewJogadorcarta : jogadorcartaCollectionNew) {
                if (!jogadorcartaCollectionOld.contains(jogadorcartaCollectionNewJogadorcarta)) {
                    Jogam oldJogamOfJogadorcartaCollectionNewJogadorcarta = jogadorcartaCollectionNewJogadorcarta.getJogam();
                    jogadorcartaCollectionNewJogadorcarta.setJogam(jogam);
                    jogadorcartaCollectionNewJogadorcarta = em.merge(jogadorcartaCollectionNewJogadorcarta);
                    if (oldJogamOfJogadorcartaCollectionNewJogadorcarta != null && !oldJogamOfJogadorcartaCollectionNewJogadorcarta.equals(jogam)) {
                        oldJogamOfJogadorcartaCollectionNewJogadorcarta.getJogadorcartaCollection().remove(jogadorcartaCollectionNewJogadorcarta);
                        oldJogamOfJogadorcartaCollectionNewJogadorcarta = em.merge(oldJogamOfJogadorcartaCollectionNewJogadorcarta);
                    }
                }
            }
            em.getTransaction().commit();
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findJogam(id) == null) {
                    throw new NonexistentEntityException("The jogam with id " + id + " no longer exists.");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(JogamPK id) throws IllegalOrphanException, NonexistentEntityException {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            ...
            try {
                ...
                throw new NonexistentEntityException("The jogam with id " + id + " no longer exists.", enfe);
            }
            List<String> illegalOrphanMessages = null;
            Collection<Ocupacao> ocupacaoCollectionOrphanCheck = jogam.getOcupacaoCollection();
            for (Ocupacao ocupacaoCollectionOrphanCheckOcupacao : ocupacaoCollectionOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Jogam (" + jogam + ") cannot be destroyed since the Ocupacao " + ocupacaoCollectionOrphanCheckOcupacao + " in its ocupacaoCollection field has a non-nullable jogam field.");
            }
            Collection<Jogadorcarta> jogadorcartaCollectionOrphanCheck = jogam.getJogadorcartaCollection();
            for (Jogadorcarta jogadorcartaCollectionOrphanCheckJogadorcarta : jogadorcartaCollectionOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Jogam (" + jogam + ") cannot be destroyed since the Jogadorcarta " + jogadorcartaCollectionOrphanCheckJogadorcarta + " in its jogadorcartaCollection field has a non-nullable jogam field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
    ...
    private List<Jogam> findJogamEntities(boolean all, int maxResults, int firstResult) {
